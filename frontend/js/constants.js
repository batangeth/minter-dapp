const contractAddress = "0xC1B0d8CF3A5CD833fc35841C9b2e85F8C81cF0B8"; //Replace with your own contract address
...
const h2_public_coming_soon = "Public Minting Countdown";
const h2_no_active_minting = "No Active Minting";
const h2_presale_mint = "Public Minting Countdown";
const h2_public_mint = "Public Minting Countdown";
...
const abi = [
	...
	{
		"inputs": [],
		"name": "disableEarlyMintIncentive",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
